...
SETL.py
This file is the main file of the program to call all the functions and pages.
- Show the home page when the program opened
- Create the menu buttons (side bar)
- Show the selected page when the button is clicked
...
class root(QMainWindow):
    def __init__(self):
        ...
        # If the program is frozen, use the .db file in the user's home directory
        if getattr(sys, 'frozen', False) and hasattr(sys, '_MEIPASS'):
            ...
            # If .db file does not exist in the user's home directory
            if not os.path.exists(destination_path):
                # Copy the .db file from the app to the user's home directory
